...
export const Navigation = ({
  ...
  return <nav className="absolute top-0 left-0 right-0 z-50 bg-spa-green-dark border-b border-spa-green">
      ...
      {/* Mobile menu */}
      {isMobileMenuOpen && <div className="fixed inset-0 bg-spa-green-dark/95 z-40 pt-20 px-4">
          <div className="flex flex-col space-y-4">
            <button onClick={() => handleSectionClick('home')} className="p-3 border-b border-spa-green text-lg font-medium text-white">
              Home
            </button>
            <Link to="/services" className="p-3 border-b border-spa-green text-lg font-medium text-white" onClick={() => setIsMobileMenuOpen(false)}>
              Services
            </Link>
            <Link to="/about" className="p-3 border-b border-spa-green text-lg font-medium text-white" onClick={() => setIsMobileMenuOpen(false)}>
              About
            </Link>
            <Link to="/contact" className="p-3 border-b border-spa-green text-lg font-medium text-white" onClick={() => setIsMobileMenuOpen(false)}>
              Contact
            </Link>
            
            {isLoggedIn ? <div className="mt-4 space-y-3">
